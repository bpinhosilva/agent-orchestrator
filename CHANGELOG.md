...
* add GitHub Actions CI workflow and update README with status badges ([06809cd](https://github.com/bpinhosilva/agent-orchestrator/commit/06809cdcf49e2877c7023e32cf0b8fb3ac5d0938))
...
* update project metadata and add repository details in package.json ([1cbe6d4](https://github.com/bpinhosilva/agent-orchestrator/commit/1cbe6d4c9832e8e6a57de6b98681806ff192a4dd))
